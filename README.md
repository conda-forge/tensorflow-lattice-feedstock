...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensorflow-lattice-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12547&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensorflow-lattice-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensorflow-lattice` can be installed with:

```
conda install tensorflow-lattice
```

It is possible to list all of the versions of `tensorflow-lattice` available on your platform with:
